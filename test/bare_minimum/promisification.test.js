...
describe('Promisification', function () {
  ...
  describe('getGitHubProfileAsync', function () {
    ...
    it('should return a promise', function () {
      ...
      expect(getGitHubProfileAsync('someRealUser')).to.be.an.instanceOf(
        Promise
      );
    });
    ...
    it('should make any errors available in the `catch` block', function (done) {
      ...
      getGitHubProfileAsync('someNonExistingUser').catch(function (err) {
  ...
  describe('readFileAndMakeItFunnyAsync', function () {
    var readFileAndMakeItFunnyAsync =
      promisificaion.readFileAndMakeItFunnyAsync;
    ...
    it.only('should make a funny file available in the `then` block', function (done) {
      readFileAndMakeItFunnyAsync(__dirname + '/../files/file_to_read.txt')
